...
class DuckDuckGoResultPage:
    RESULT_LINKS = (By.CSS_SELECTOR, 'h2.js-result-title')
    SEARCH_INPUT = (By.ID, 'search_form_input')

    @classmethod
    def PHRASE_RESULTS(cls, phrase):
        xpath = f"//div[@id='links']/div[contains(@class,'results')]//*[contains(text(),'{phrase}')]"
    ...
    def link_div_count(self):
        link_divs = self.browser.find_elements(*self.RESULT_LINKS)
